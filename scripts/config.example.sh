...
export AER_ADDR_WIDTH="${AER_ADDR_WIDTH:-8}"
...
export AER_CLOCK_PORT="${AER_CLOCK_PORT:-clk_i}"
export AER_RESET_PORT="${AER_RESET_PORT:-rst_ni}"
...
export AER_CORNER="${AER_CORNER:-provisional_slow_0p9v_125c}"
