...
grep -Fq '"integration_commit": "a57943adba759fc955b4506e99703c1dd9736fba"' <<<"$canonical"
...
printf '%s\n' 'REDRED_SINGLE_EDGE_CDC_RDC_ALL_PASS source=a57943a integration=a57943a mutations=22'
