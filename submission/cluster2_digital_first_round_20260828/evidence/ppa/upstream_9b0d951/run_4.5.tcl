...
report_area  > $OUT_DIR/aer_tx16_trad_rowcol_fovea_cluster2_steal_buf_polarity_4.5_pnr_area.rpt
report_power > $OUT_DIR/aer_tx16_trad_rowcol_fovea_cluster2_steal_buf_polarity_4.5_pnr_power.rpt
...
catch {check_timing -verbose > $OUT_DIR/aer_tx16_trad_rowcol_fovea_cluster2_steal_buf_polarity_4.5_check_timing.rpt}
catch {verify_drc -report $OUT_DIR/aer_tx16_trad_rowcol_fovea_cluster2_steal_buf_polarity_4.5_drc.rpt}
catch {verify_process_antenna -report $OUT_DIR/aer_tx16_trad_rowcol_fovea_cluster2_steal_buf_polarity_4.5_antenna.rpt}
catch {write_db $OUT_DIR/aer_tx16_trad_rowcol_fovea_cluster2_steal_buf_polarity_4.5_db}
exit
