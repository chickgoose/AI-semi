...
Status: **eligibility-accounting HOLD CLOSED** against governing schema v5,
...
Its schema-v5 requirements take precedence over any use of “zero-feature” or
...
PPA. The TB binding module itself remains excluded as required by schema v5;
