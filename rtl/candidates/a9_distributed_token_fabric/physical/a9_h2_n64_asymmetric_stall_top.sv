...
// Optional N=64 asymmetric-stall experiment only.  The instantiated shell is
// exactly the registered phase-4 comparison boundary and must be compiled with
// A9_PHASE4_DIFFUSIVE.  This is not an N=16 default shortlist.
module a9_h2_n64_asymmetric_stall_top (
  input  logic          clk_i,
  input  logic          rst_ni,
