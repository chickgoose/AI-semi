...
// Drop-in technology-bound implementation of the frozen owner endpoint.
// Owner launch/observer RTL is instantiated directly and is never modified.
module w2_p6_exact_pair_endpoint_tech (
