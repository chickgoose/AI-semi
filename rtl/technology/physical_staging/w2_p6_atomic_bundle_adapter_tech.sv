...
module w2_p6_atomic_bundle_adapter_tech (
  ...
  // Preserve this boundary so pre-map and mapped receipts can distinguish
  // explicit endpoint technology leaves from scheduler/buffer cells that the
  // synthesis flow may legitimately add or remap.
  (* keep_hierarchy = "yes", dont_touch = "true",
     w2_endpoint_root = "p6" *)
  w2_p6_exact_pair_endpoint_tech w2_endpoint_link__p6 (
